...
$a = $_POST['nazev'];
$b = $_POST['autor'];
if (!empty($a) and !empty($b) and !empty($_POST["clanek"]) and !empty($_POST["perex"])) {
mysql_query("SET character_set_client=utf8");
mysql_query("SET character_set_connection=utf8");
mysql_query("SET character_set_results=utf8");
$datum = StrFTime("%d/%m/%Y %H:%M:%S", Time());
mysql_query("INSERT INTO `clanky` (`nazev`, `perex`, `text`, `autor`, `datum`) values ('$a', '".$_POST["perex"]."', '".$_POST["clanek"]."', '".$_POST["autor"]."', '$datum')");
echo "<p align='center'>Článek <strong>$a</strong> byl přidán</p>";
echo "<p align='center'><a href='pridat_clanek.php'><span style='color: black;'>Přidat další</span></a> | <a href='index.php'><span style='color: black;'>Seznam článků</span></a></p>";
}
else {
echo "<p align='center'>Článek <strong>$a</strong> nebyl přidán.Jedno z polí nebylo vyplněno!</p>";
echo "<p align='center'><a href='pridat_clanek.php'><span style='color: black;'>Zpět</span></a></p>";
}
?>
