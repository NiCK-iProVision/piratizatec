...
<form method="POST" action="upravit_clanek_s.php" >
<?php
$id=$_GET['id'] ;
...
{
echo '<input type="text" style="display:none" name="id" value="'.$vypsat["id"].'"></input>';
?>
Nadpis článku:<br><input class="textbox" type="text" name="nazev" value="<?php echo $vypsat["nazev"]; ?>" size="20"><br><br>
Autor:<br><input class="textbox" type="text" name="autor" value="<?php echo $vypsat["autor"]; ?>" size="20"><br><br>
<p align="center" class="adminh">Perex:</p><br />
<?php
$FCKeditor = new FCKeditor('perex');
$FCKeditor->BasePath = 'fckeditor/';
$FCKeditor->Height = '300';
$FCKeditor->Value = $vypsat["perex"];
$FCKeditor->Create();
?>   
